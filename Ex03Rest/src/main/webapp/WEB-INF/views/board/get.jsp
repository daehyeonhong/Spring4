  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button id="modalModBtn" type="button" class="btn btn-danger">
          삭제
        </button>
      ...
      function (replyCount, list) {
        ...
        for (let i = 0, len = list.length || 0; i < len; i++) {
          str +=
            ...
            replyService.displayTime(list[i].reply_date) +
            "</small></div><p>" +
            list[i].reply +
            "</p></div></li>";
        }
