						...
						<tr>
							...
							<td>
								<button class="btn btn-danger btn-circle"
									onclick="updateGoodCnt(this)" data-bno='${board.bno}'>
									<i class="fa fa-heart">${board.good}</i>
								</button>
								<button class="btn btn-warning btn-circle"
									onclick="updateBadCnt(this)" data-bno='${board.bno}'>
									<i class="fa fa-times">${board.bad}</i>
								</button>
							</td>
					...
					<div class="col-lg-12">
						...
						<form id='searchForm' action="/board/list" method='get'>
							<select name='type'>
								...
								value='<c:out value="${pageMaker.criteria.pageNumber}"/>' /> <input
					...
					function() {
						...
						$(".paginate_button a").on(
								...
								function(e) {
									e.preventDefault();
									console.log('click');
									actionForm.find("input[name='pageNumber']")
											.val($(this).attr("href"));
									actionForm.submit();
								});
						$(".move")
						...
						$("#searchForm button").on(
								...
								function(e) {
									...
									searchForm.find("input[name='pageNumber']")
											.val("1");
									e.preventDefault();
									searchForm.submit();
								});
